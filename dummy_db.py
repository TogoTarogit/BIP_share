...
def create_dummy_data():
    ...
    q7 = Question(title="保育園の行事って強制参加なんですかね？", content="0歳児クラスの娘がいます(1歳になったばかり)今月入園し、今は慣らし保育中です。明日夏祭りがあります。8時40分からで、0歳児クラスは踊ったりがなく、ゲームコーナー(輪投げ、ボーリング、ヨーヨー釣りなど)を回って解散って感じです。多分30分から1時間ぐらいで終わるかなと思ってます。ですがあまり前向きになれません。理由は、入園して直ぐという事もあり、なにがなんだかわからない。旦那は仕事があるため、私と娘2人で行かなきゃいけないし、娘は歩けないのでずっと抱っこだと思うし、1歳の子なんて輪投げやボーリングとかもできるはずないので、多分私が代わりにしなきゃいけないと思うと、心細い気持ちと、疲れるだろうなと思い前向きになれません。本音は行きたくないです。でも行かなきゃいけないのかなという葛藤で…今日は眠れそうにないです。", timestamp=random_past_datetime(),image_data = q7_image)
    # 質問をセッションに追加
    db.session.add(q1)
    db.session.add(q2)
    db.session.add(q3)
